const { Profile, Contract, Job, sequelize, Transaction } = require("../src/model");
...
async function seed() {
  ...
  sequelize.transaction({
    ...
    // With CLS enabled, Profile, Contract and Job seed data will be created inside the transaction
