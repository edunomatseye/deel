...
describe('getBestClients', () => {
  it('should return a list of best clients for a given date range and limit', async () => {
    ...
    const mockedBestPayClient = [{ firstName: 'John', lastName: 'Doe' }, { firstName: 'Alice', lastName: 'Doe' }];
    JobsService.prototype.findBestPayingClients.mockResolvedValue(mockedBestPayClient)
...
describe('getAllUnpaidJob', () => {
  it('should return a list of unpaid jobs for the authenticated user', async () => {
    ...
    JobsService.prototype.getUnpaidJobs.mockResolvedValue([{ id: 1 }, { id: 2 }]),
  ...
  it('should return a 401 status with an error message if there is an error', async () => {
    ...
    JobsService.prototype.getUnpaidJobs.mockRejectedValue(new Error('Error message'));
